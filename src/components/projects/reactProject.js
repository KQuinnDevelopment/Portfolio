...
const content = {
	...
	"thoughts": ["It makes use of (now out of date) data on lots in Burlington pulled from municiple sources.",
		"I enjoyed using React to build this web application, I hope I get to improve upon what I had learned.",
		"I don't know if I will go back to it, I hope to work on other React projects in the future that display more up-to-date use of the technology."]
};
